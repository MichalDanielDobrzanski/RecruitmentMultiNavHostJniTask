...
@AndroidEntryPoint
class ListFragment : MainMovieFragment() {

    override fun itemLayoutId(): Int = R.layout.movie_list_item_view

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? =
        container?.inflateNoAttach(R.layout.main_list_fragment)
